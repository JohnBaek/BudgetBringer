...
docker run --name budget-bringer-database --innodb_flush_method=fsync -e TZ=Asia/Seoul --restart=unless-stopped -v /mnt/datadisk1/sources/tmp:/tmp -v /mnt/datadisk1/sources/budget-data:/var/lib/mysql --network=sgs-net --ip=172.28.0.30 -p 3309:3306 -d sgs/budget-bringer-database:latest
