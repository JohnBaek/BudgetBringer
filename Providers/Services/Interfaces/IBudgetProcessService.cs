...
public interface IBudgetProcessService
{
    ...
    /// <param name="year">년도 정보</param>
    /// <returns></returns>
    Task<ResponseData<ResponseProcessApprovedSummary>> GetApprovedBelowAmountSummaryAsync(string year);
    ...
    /// <param name="year">년도 정보</param>
    /// <returns></returns>
    Task<ResponseData<ResponseProcessApprovedSummary>> GetApprovedAboveAmountSummaryAsync(string year);
}