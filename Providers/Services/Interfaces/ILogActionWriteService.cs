...
public interface ILogActionWriteService
{
    ...
    /// <returns></returns>
    Task<Response> WriteUpdate<T>(T before, T after, DbModelUser user, string contents)
        where T : class;
    ...
    /// <typeparam name="T">모델 T</typeparam>
    /// <returns></returns>
    Task<Response> WriteAddition<T>(T before, DbModelUser user, string contents) 
        where T : class;
    ...
    /// <typeparam name="T">모델 T</typeparam>
    /// <returns></returns>
    Task<Response> WriteDeletion<T>(T before, DbModelUser user, string contents) 
        where T : class;
}