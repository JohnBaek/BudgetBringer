...
public class BudgetPlanRepository : IBudgetPlanRepository
{
    ...
    public BudgetPlanRepository(AnalysisDbContext dbContext, ILogger<BudgetPlanRepository> logger)
    {
    ...
    /// <returns></returns>
    public async Task<List<DbModelBudget>> GetListAsync(RequestQuery requestQuery)
    {
