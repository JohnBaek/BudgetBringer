...
namespace Models.DataModels.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Budgets_CountryBusinessManagers_CountryBusinessManagerId",
                        column: x => x.CountryBusinessManagerId,
                        principalTable: "CountryBusinessManagers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Budgets_Sectors_SectorId",
                        column: x => x.SectorId,
                        principalTable: "Sectors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Budgets_CountryBusinessManagerId",
                table: "Budgets",
                column: "CountryBusinessManagerId");

            migrationBuilder.CreateIndex(
                name: "IX_Budgets_SectorId",
                table: "Budgets",
                column: "SectorId");
